...
class PassengerLanguageService {
  ...
  static final Map<String, Map<PassengerLanguage, String>> _tr = {
    ...
    'home.rideType': {
      PassengerLanguage.english: 'Transport Type',
      PassengerLanguage.french: 'Type de transport',
      PassengerLanguage.kinyarwanda: 'Ubwoko bw Urujya-nk\u02b9uru',
      PassengerLanguage.swahili: 'Aina ya Usafiri',
      PassengerLanguage.spanish: 'Tipo de transporte',
    },
    'home.private': {
    ...
    'home.privateDesc': {
      PassengerLanguage.english: 'Transport by car',
      PassengerLanguage.french: 'Transport en voiture',
      PassengerLanguage.kinyarwanda: 'Ubwikorezi mu modoka',
      PassengerLanguage.swahili: 'Usafiri wa gari',
      PassengerLanguage.spanish: 'Transporte en carro',
    },
    'home.public': {
      PassengerLanguage.english: 'Public transport (Bus)',
      PassengerLanguage.french: 'Transport public (Bus)',
      PassengerLanguage.kinyarwanda: 'Ubwikorezi Rusange (Bisi)',
      PassengerLanguage.swahili: 'Usafiri wa Umma (Basi)',
      PassengerLanguage.spanish: 'Transporte público (Autobús)',
    },
    'home.publicDesc': {
      PassengerLanguage.english: 'Reserve a seat',
      PassengerLanguage.french: 'Reserver une place',
      PassengerLanguage.kinyarwanda: 'Bika intebe',
      PassengerLanguage.swahili: 'Weka kiti',
      PassengerLanguage.spanish: 'Reserva un asiento',
    },
    'home.motorcycle': {
      PassengerLanguage.english: 'Motor Vehicle',
      PassengerLanguage.french: 'Vehicule a moteur',
      PassengerLanguage.kinyarwanda: 'Imodoka y imbaraga',
      PassengerLanguage.swahili: 'Gari la motor',
      PassengerLanguage.spanish: 'Vehiculo a motor',
    },
    'home.motorcycleDesc': {
      PassengerLanguage.english: 'Quick point-to-point transport',
      PassengerLanguage.french: 'Transport rapide point a point',
      PassengerLanguage.kinyarwanda:
          'Ubwikorezi bwihuse kuva aha kugera hariya',
      PassengerLanguage.swahili: 'Usafiri wa haraka wa moja kwa moja',
      PassengerLanguage.spanish: 'Transporte rapido de punto a punto',
    },
    ...
    'transportType.private': {
      PassengerLanguage.english: 'Private',
      PassengerLanguage.french: 'Priv\u00e9',
      PassengerLanguage.kinyarwanda: 'Privee',
      PassengerLanguage.swahili: 'Binafsi',
      PassengerLanguage.spanish: 'Privado',
    },
    'transportType.motorVehicle': {
      PassengerLanguage.english: 'Motor Vehicle',
      PassengerLanguage.french: 'V\u00e9hicule \u00e0 moteur',
      PassengerLanguage.kinyarwanda: 'Imodoka y\u2019imodoka / Moto',
      PassengerLanguage.swahili: 'Gari la motor',
      PassengerLanguage.spanish: 'Veh\u00edculo a motor',
    },
    'home.nearbyDrivers': {
    ...
    'book.chooseRideType': {
      PassengerLanguage.english: 'Choose Transport Type',
      PassengerLanguage.french: 'Choisir le type de transport',
      PassengerLanguage.kinyarwanda: 'Hitamo ubwoko bw Urujya-nk\u02b9uru',
      PassengerLanguage.swahili: 'Chagua Aina ya Usafiri',
      PassengerLanguage.spanish: 'Elige tipo de transporte',
    },
    ...
    'bus.activeBuses': {
      PassengerLanguage.english: 'Active Buses',
      PassengerLanguage.french: 'Bus actifs',
      PassengerLanguage.kinyarwanda: 'Mabisi akora',
      PassengerLanguage.swahili: 'Mabasi yanayotumika',
      PassengerLanguage.spanish: 'Buses activos',
    },
    'bus.corridor': {
      PassengerLanguage.english: 'Corridor',
      PassengerLanguage.french: 'Couloir',
      PassengerLanguage.kinyarwanda: 'Koridoro',
      PassengerLanguage.swahili: 'Njia',
      PassengerLanguage.spanish: 'Corredor',
    },
    'bus.boardingStop': {
      PassengerLanguage.english: 'Boarding stop',
      PassengerLanguage.french: 'Arret de depart',
      PassengerLanguage.kinyarwanda: 'Aho uzamuka',
      PassengerLanguage.swahili: 'Kituo cha kupanda',
      PassengerLanguage.spanish: 'Parada de abordaje',
    },
    'bus.destinationStop': {
      PassengerLanguage.english: 'Destination stop',
      PassengerLanguage.french: 'Arret de destination',
      PassengerLanguage.kinyarwanda: 'Aho uzamanuka',
      PassengerLanguage.swahili: 'Kituo cha kushuka',
      PassengerLanguage.spanish: 'Parada de destino',
    },
    'bus.seatsReserved': {
      PassengerLanguage.english: 'Seats reserved',
      PassengerLanguage.french: 'Places reservees',
      PassengerLanguage.kinyarwanda: 'Intebe zabitswe',
      PassengerLanguage.swahili: 'Viti vilivyohifadhiwa',
      PassengerLanguage.spanish: 'Asientos reservados',
    },
    'bus.selectRequired': {
      PassengerLanguage.english:
          'Select a corridor, boarding stop, and destination stop.',
      PassengerLanguage.french:
          'Selectionnez un corridor, un arret de depart et un arret de destination.',
      PassengerLanguage.kinyarwanda:
          'Hitamo koridoro, aho uzamuka, n aho uzamanuka.',
      PassengerLanguage.swahili:
          'Chagua njia, kituo cha kupanda, na kituo cha kushuka.',
      PassengerLanguage.spanish:
          'Seleccione un corredor, una parada de abordaje y una parada de destino.',
    },
    'bus.minSeats': {
      PassengerLanguage.english: 'Seats reserved must be at least 1.',
      PassengerLanguage.french: 'Les places reservees doivent etre au moins 1.',
      PassengerLanguage.kinyarwanda: 'Intebe zabitswe zigomba kuba byibura 1.',
      PassengerLanguage.swahili: 'Viti vilivyohifadhiwa lazima viwe angalau 1.',
      PassengerLanguage.spanish:
          'Los asientos reservados deben ser al menos 1.',
    },
    'bus.selectBus': {
      PassengerLanguage.english: 'Select Bus',
      PassengerLanguage.french: 'Selectionner le bus',
      PassengerLanguage.kinyarwanda: 'Hitamo bisi',
      PassengerLanguage.swahili: 'Chagua basi',
      PassengerLanguage.spanish: 'Seleccionar autobus',
    },
    'bus.selectedBus': {
      PassengerLanguage.english: 'Selected Bus',
      PassengerLanguage.french: 'Bus selectionne',
      PassengerLanguage.kinyarwanda: 'Bisi yatoranijwe',
      PassengerLanguage.swahili: 'Basi lililochaguliwa',
      PassengerLanguage.spanish: 'Autobus seleccionado',
    },
    'bus.locationDisabled': {
      PassengerLanguage.english:
          'Location disabled — showing approximate bus positions.',
      PassengerLanguage.french:
          'Localisation desactivee — affichage des positions approximatives des bus.',
      PassengerLanguage.kinyarwanda:
          'Ahantu hafunzwe — herekanwa imyanya ya bisi iteganyijwe.',
      PassengerLanguage.swahili:
          'Mahali kumewashwa — kuonyesha nafasi za basi zinazokadiriwa.',
      PassengerLanguage.spanish:
          'Ubicacion desactivada — mostrando posiciones aproximadas de los buses.',
    },
    'bus.refreshBuses': {
      PassengerLanguage.english: 'Refresh buses',
      PassengerLanguage.french: 'Rafraichir les bus',
      PassengerLanguage.kinyarwanda: 'Ongera usome bisi',
      PassengerLanguage.swahili: 'Onyesha mabasi upya',
      PassengerLanguage.spanish: 'Actualizar buses',
    },
    'bus.chooseAnother': {
      PassengerLanguage.english: 'Choose another bus',
      PassengerLanguage.french: 'Choisir un autre bus',
      PassengerLanguage.kinyarwanda: 'Hitamo indi bisi',
      PassengerLanguage.swahili: 'Chagua basi lingine',
      PassengerLanguage.spanish: 'Elegir otro autobus',
    },
    'bus.continueWithoutSelection': {
      PassengerLanguage.english: 'Continue without selection',
      PassengerLanguage.french: 'Continuer sans selection',
      PassengerLanguage.kinyarwanda: 'Komeza utihitiyemo',
      PassengerLanguage.swahili: 'Endelea bila kuchagua',
      PassengerLanguage.spanish: 'Continuar sin seleccion',
    },
    'bus.noActiveBuses': {
      PassengerLanguage.english: 'No active buses found for this corridor.',
      PassengerLanguage.french: 'Aucun bus actif pour ce corridor.',
      PassengerLanguage.kinyarwanda:
          'Nta bisi ikora ibonetse kuri uyu murongo.',
      PassengerLanguage.swahili:
          'Hakuna basi linalofanya kazi kwenye njia hii.',
      PassengerLanguage.spanish:
          'No se encontraron buses activos para este corredor.',
    },
    'bus.bookingSummary': {
      PassengerLanguage.english: 'Booking Summary',
      PassengerLanguage.french: 'Resume de la reservation',
      PassengerLanguage.kinyarwanda: 'Inshamake y ibyabugenewe',
      PassengerLanguage.swahili: 'Muhtasari wa booking',
      PassengerLanguage.spanish: 'Resumen de reserva',
    },
    'bus.bookNow': {
      PassengerLanguage.english: 'Book bus seat',
      PassengerLanguage.french: 'Reserver une place',
      PassengerLanguage.kinyarwanda: 'Bika intebe ya bisi',
      PassengerLanguage.swahili: 'Weka kiti cha basi',
      PassengerLanguage.spanish: 'Reservar asiento',
    },
    'book.rateTrip': {
    ...
    'ride.prefRideType': {
      PassengerLanguage.english: 'Preferred Transport Type',
      PassengerLanguage.french: 'Type de transport prefere',
      PassengerLanguage.kinyarwanda: 'Ubwoko bw Urujya-nk\u02b9uru ukunda',
      PassengerLanguage.swahili: 'Aina ya Usafiri unayopendelea',
      PassengerLanguage.spanish: 'Tipo de transporte preferido',
    },
    'ride.tripUpdates': {
